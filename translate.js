document.addEventListener("DOMContentLoaded", () => {
  const translations = {
    pl: {
      ...
      hero_desc: "M-TRANS Mariusz Dybowski – Twój zaufany partner w transporcie międzynarodowym od 16 lat.",
    ...
    en: {
      ...
      hero_desc: "M-TRANS Mariusz Dybowski – your trusted partner in international transport for 16 years.",
      btn_offer: "Our Offer",
